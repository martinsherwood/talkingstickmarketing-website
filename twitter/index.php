...
//Simple OAuth for the Twitter API, followed about a thousand tutorials for this

if(empty($_POST)) { die(); }

class Tweets {

	//these are from the talking stick app, on my personal account (change later if needed)
    private $consumer_key    = 'h1OU8rs9HK98AFgzErxKQ';
    private $consumer_secret = 'rLn27AvtZSPiFe9NYFJWvNbdXSd2k3ZwskMSpLaPuY';
    private $user_token      = '195512076-xXWeR5N6fWZNQEhTKK0I9cwhv3XiInqmseRIDcxP';
    private $user_secret     = '5UHubHcNsDFWtl3TdkDGmDlSuW8xQWD9TBhRhKFxA';
    private $lib             = './lib/'; //CHECK THIS
    private $cache_enabled   = true;
    private $cache_interval  = 15; //15 minutes for the cache
    private $cache_dir       = './';
    private $debug           = false; //MAKE FALSE, TRUE FOR DEV
    ...
    private function getTwitterJSON() {
        require $this->lib.'oauth.php';
        require $this->lib.'utilities.php';
        ...
        $oauth->request('GET', $oauth->url($url), $params);
        return $oauth->response;
    }

    private function generateCFID() {
        //unique cached filename
